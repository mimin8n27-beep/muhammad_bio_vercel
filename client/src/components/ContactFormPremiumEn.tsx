...
interface ContactFormPremiumEnProps {
...
export default function ContactFormPremiumEn({
  whatsappNumber,
  email,
  source = "website",
}: ContactFormPremiumEnProps) {
    ...
    <div className="surface-card surface-card-glow light-sweep mx-auto max-w-6xl p-7 md:p-10 lg:p-12">
      <div className="grid gap-10 lg:grid-cols-[1.02fr_0.98fr] lg:gap-12">
        <div>
          ...
          <h3 className="mb-4 text-4xl font-bold leading-[1.02] text-white md:text-5xl">
            Show me where operations slow down, and I&apos;ll turn it into cleaner automation.
          </h3>
          <p className="mb-7 max-w-xl text-[1.04rem] leading-8 text-[#c8ddf0]">
            Share the current process, the tools involved, and where time is being lost in manual work.
            Whether you need n8n workflows, cross-platform integrations, or AI-powered automation layers,
            the goal is a system that feels premium, reliable, and easy to operate.
          </p>
          ...
          <div className="mt-7 inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-2.5 text-sm text-[#d8ecff]">
            ...
            Direct contact for automation systems, integrations, and AI workflows.
          </div>
        </div>
        ...
        <div className="relative z-20">
          {submitted ? (
            <div className="surface-card-glow flex min-h-[28rem] flex-col items-center justify-center rounded-[1.6rem] border border-primary/15 bg-primary/8 p-8 text-center">
              ...
              <h4 className="mb-2 text-2xl font-bold">Project request received</h4>
              <p className="max-w-sm text-muted-foreground">
                Your message reached the inbox successfully. I&apos;ll review it and come back with the best next step.
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="relative z-20 grid gap-5">
              ...
              <div>
                <label className="mb-2 block text-sm font-semibold text-[#dcecff]">Company or brand</label>
                <div className="field-shell">
                  <input
                    className="field-input"
                    name="company"
              ...
              <div>
                ...
                <div className="field-shell">
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="Describe the current process, the tools involved, and the result you want from automation."
                    required
                  />
                </div>
              </div>
